...
import {
  Phone, User, Pause, ArrowLeft, Send,
  Mic, ToggleLeft, ToggleRight, AlertCircle, Heart
} from 'lucide-react';
    ...
    <div className="chat-screen">
      <header className="chat-header">
        ...
        <div className="chat-header-right">
          <button className="chat-header-button"><Phone size={20} /></button>
          <button className="chat-header-button"><User size={20} /></button>
          <button className="chat-header-button"><Pause size={20} /></button>
        </div>
      </header>
      ...
      <main className="chat-main">
            ...
            >
              <div className="conflict-suggestion-inner">
                ...
                <div>
                  ...
                  <p>A therapist could help navigate this discussion more effectively.</p>
                  <div className="suggestion-actions">
                    <button onClick={() => navigate('/therapists')}>Find a Therapist</button>
        ...
        {conversation.conflictStatus === 'active' && (
          <motion.div className="reconciliation-block" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            <div className="reconciliation-inner">
              <Heart size={20} />
              <div>
                <h3>Reconciliation suggestion</h3>
                <p>Consider a gesture to help resolve this discussion positively.</p>
                <div className="reconciliation-actions">
                  <button onClick={() => navigate('/reconciliation')}>View Options</button>
                </div>
              </div>
            </div>
          </motion.div>
      ...
      <footer className="chat-footer">
        ...
        <div className="footer-input-row">
          <textarea
            ...
            rows={1}
          />
          <button className="footer-icon-btn"><Mic size={22} /></button>
          <button
